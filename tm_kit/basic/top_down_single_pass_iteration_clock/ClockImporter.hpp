#ifndef TM_KIT_BASIC_TOP_DOWN_SINGLE_PASS_ITERATION_CLOCK_CLOCK_IMPORTER_HPP_
#define TM_KIT_BASIC_TOP_DOWN_SINGLE_PASS_ITERATION_CLOCK_CLOCK_IMPORTER_HPP_
        ...
        static std::shared_ptr<typename M::template Importer<T>> createOneShotClockImporter(typename Env::TimePointType const &tp, std::function<T(typename Env::TimePointType const &)> generator) {
            ...
            public:
                ...
                virtual std::tuple<bool, typename M::template Data<T>> generate(T const *notUsed=nullptr) override final {
                    ...
                    return {false, { typename M::template InnerData<T> {
